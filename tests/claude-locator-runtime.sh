...
for name in ANTHROPIC_API_KEY ANTHROPIC_AUTH_TOKEN ANTHROPIC_BEARER_TOKEN ANTHROPIC_CONSOLE_API_KEY ANTHROPIC_CONSOLE_AUTH_TOKEN BASH_ENV ENV CLAUDE_RUNTIME_CANCELLATION_REQUEST_FILE CLAUDE_RUNTIME_CANCELLATION_ACTIVE_FILE NODE_OPTIONS NODE_PATH OPENSSL_CONF OPENSSL_CONF_INCLUDE OPENSSL_ENGINES OPENSSL_MODULES PYTHONPATH RUBYOPT PERL5OPT ZDOTDIR; do
...
(
  ...
  CLAUDE_RUNTIME_CANCELLATION_REQUEST_FILE="$TEST_ROOT/runtime-cancel-request"
  CLAUDE_RUNTIME_CANCELLATION_ACTIVE_FILE="$TEST_ROOT/runtime-driver-active"
  ...
  export HOME TMPDIR LC_ALL HTTPS_PROXY NO_PROXY NODE_EXTRA_CA_CERTS NODE_OPTIONS NODE_PATH OPENSSL_CONF OPENSSL_CONF_INCLUDE OPENSSL_ENGINES OPENSSL_MODULES CLAUDE_RUNTIME_CANCELLATION_REQUEST_FILE CLAUDE_RUNTIME_CANCELLATION_ACTIVE_FILE PYTHONPATH RUBYOPT PERL5OPT ZDOTDIR CDPATH
...
for scrubbed_name in CLAUDE_RUNTIME_CANCELLATION_REQUEST_FILE CLAUDE_RUNTIME_CANCELLATION_ACTIVE_FILE NODE_OPTIONS NODE_PATH OPENSSL_CONF OPENSSL_CONF_INCLUDE OPENSSL_ENGINES OPENSSL_MODULES PYTHONPATH RUBYOPT PERL5OPT ZDOTDIR; do
...
assert_eq "direct_inherited_path_v14" "$CLAUDE_RUNTIME_CONTRACT" "runtime contract label"
